...
void dh_sw::NN_DigitDivLH (NN_HALF_DIGIT &aLow, NN_DIGIT t[2], NN_DIGIT c) {
	// If the hw is not enabled and done has been deasserted then can run hw
